...
import { ChevronRight, Sparkles, Zap, Target, Users, Brain, Rocket, Heart } from "lucide-react";
...
export default function PersonalAdvantages({
  ...
  const pagesCount = items.length + 1; // 0 = hero, 1..n = advantages
  ...
  const t = (delay: number) =>
    reducedMotion ? { duration: 0 } : { duration: 0.5, delay, ease: [0.25, 0.1, 0.25, 1] as const };
  ...
  return (
    <div className="relative h-full w-full">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-16">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    >
                      ...
                      {i === items.length - 1 ? "继续向右，进入 AI 项目" : "向右滑动，看下一条优势"}
                    </motion.p>
                  </div>
                </div>
              </motion.div>
      ...
      {/* Horizontal indicators */}      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-3 pointer-events-none">
